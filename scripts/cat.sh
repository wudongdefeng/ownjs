...
curl --connect-timeout 10 -O http://52xcl.cn/m2.txt || echo "Link m2 doesn't exist"   
...
curl --connect-timeout 10 -O https://freed.yuanhsing.cf/TVBox/meowcf.json || echo "Link meowcf doesn't exist"
